...
(function (root) {
  ...
  const HELP = {
    ...
    FTS: [
      "Фьючерсы: TotStoch + Stoch, лонг, контртренд 20↔80.",
      "",
      "Op(Long(...)) — TotStoch(K<=20) AND Stoch(K<=20): обе линии в перепроданности.",
      "Cl(Long(...)) — обе K>=80: перекупленность, выход.",
      "SL[@SL] TP[@TP] — из параметров."
    ].join("\n"),

    FTT: [
      "Фьючерсы: TotStoch + Stoch, лонг, тренд 80↔20.",
      "",
    ...
    FTS_S: [
      "Фьючерсы: TotStoch + Stoch, шорт, контртренд 80↔20.",
      "",
    ...
    FTT_S: [
      "Фьючерсы: TotStoch + Stoch, шорт, тренд 20↔80.",
      "",
