...
(function (root) {
  ...
  const HELP = {
    ...
    TBRU: [
      "Портфель облигаций по составу БПИФ TBRU (porti.ru / MOEX:TBRU).",
      "",
      "Reconcile: только облигации на счёте; deploy-конверт по цене × цель по yield; минимум сделок.",
      "Live: на каждом опросе TF — перечитывание состава с porti.ru и rebalance.",
      "Расчёт: симуляция по периоду/TF с купонами и погашением; FINRESP = итоговая equity − deploy.",
