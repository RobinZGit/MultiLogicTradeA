 ...
 *   - `ADX(14;Max=25)(WkOk)` слабый тренд / флэт (боковик)
 * - Short выход:
...
(function (root) {
  ...
  root.MultiLogicFinrespLogics.register({
    ...
    defaultLine:
      F("BOKOVIK_REGIME")
      + "Op(Short(SMA(100)(Bl) AND Stoch(14-3-3;Lmin=90;Smax=10)(K>=90) AND ATR(14;Gr=3%;Lb=5)(GrOk) AND ADX(14;Max=25)(WkOk) AND MACD(12,26,9)(Macd<Sig))) "
